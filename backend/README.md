...
## Project Structure
    ...
    ├── testapiautostorybo_112759  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112759`
...
2. Clone this repo and `cd testapiautostorybo_112759`
